...
#$ -l excl=true
#$ -l mem_free=90G
#$ -o cpu_search.profile.TLB.out
#$ -e cpu_search.profile.TLB.out
...
ksteps="1 2 3 4"
indexExt="fmi"
bin_extension="-profile"

#Likwid profile options
profile_command="likwid-perfctr -m -g DTLB_LOAD_MISSES_WALK_COMPLETED:PMC0,DTLB_LOAD_MISSES_STLB_HIT:PMC1,DTLB_LOAD_MISSES_WALK_CYCLES:PMC2,MEM_INST_RETIRED_LOADS:PMC3,UNC_QMC_NORMAL_READS_ANY:UPMC0 -C 0-23"
